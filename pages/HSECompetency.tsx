  ...
  return (
    <div className="pb-24">
      ...
      <div className="relative bg-slate-950 py-32 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          <div className="max-w-3xl">
            <h1 className="text-4xl md:text-6xl font-bold text-white mb-8 tracking-tight">HSE Competency & Compliance</h1>
            <p className="text-xl text-slate-300 leading-relaxed font-light">
              We specialize in bridging the gap between regulatory requirements and operational excellence, ensuring your workforce is technically equipped to manage health, safety, and environmental risks with precision.
            </p>
          </div>
        </div>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 -mt-16 relative z-20">
        ...
        {/* HSE Methodology Section */}
        <div className="mt-40">
          <div className="text-center mb-20">
            <span className="text-blue-600 font-bold uppercase tracking-[0.4em] text-[10px] mb-4 block">Compliance Strategy Phase</span>
            <h2 className="text-4xl font-bold text-slate-900">Safety Implementation Lifecycle</h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 relative">
            ...
            {[
              ...
              { step: "03", title: "Certification", desc: "Delivery of accredited training modules and regulatory certifications." },
              { step: "04", title: "Validation", desc: "Post-training assessments and field inspections to verify safety mastery." }
            ].map((m, i) => (
